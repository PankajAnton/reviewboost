...
export const metadata: Metadata = {
  title: "Cookie Policy — ReviewBoost",
  description: "How ReviewBoost uses cookies.",
};
    ...
    >
          ...
          <table className="w-full min-w-[520px] border-collapse text-left text-sm text-zinc-400">
            <thead>
              <tr className="border-b border-zinc-800 bg-zinc-900/80 text-zinc-300">
                ...
                <th className="px-4 py-3 font-display font-semibold">Purpose</th>
                <th className="px-4 py-3 font-display font-semibold">Duration</th>
                <th className="px-4 py-3 font-display font-semibold">Type</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-zinc-800">
              <tr>
                <td className="px-4 py-3 font-mono text-xs text-orange-400/90">
                  session_token
                </td>
      ...
      <LegalSection title="3. Essential Cookies">
        <p>
          ...
          these while using ReviewBoost.
        </p>
      </LegalSection>

      <LegalSection title="4. Analytics Cookies">
        <p>
          We use Vercel Analytics for anonymous usage data — no personal
          information is collected. You can opt out by enabling &quot;Do Not
      ...
      <LegalSection title="5. Third-Party Cookies">
        <p>
          Razorpay may set cookies during payment flows. These are governed by
          Razorpay&apos;s own cookie policy.
        </p>
      </LegalSection>

      <LegalSection title="6. Managing Cookies">
        <p>
          You can clear cookies in your browser settings at any time. Note:
          clearing session cookies will log you out.
        </p>
      </LegalSection>
    </LegalLayout>
  );
