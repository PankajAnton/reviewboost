...
export const metadata: Metadata = {
  ...
  description:
    "How ReviewBoost collects, uses, and protects your information.",
};
    ...
    >
      <LegalSection title="1. Information We Collect">
        ...
        <ul className="list-disc space-y-2 pl-5 marker:text-orange-500">
          ...
          <li>
            Restaurant information: restaurant name and Google Maps review URLs
            you provide
          </li>
          <li>
            Customer feedback: ratings and comments submitted by your customers
            via QR codes
          </li>
          <li>Usage data: pages visited, features used, login timestamps</li>
          <li>
            Payment information: processed securely by Razorpay — we never store
            card details
          </li>
        </ul>
      </LegalSection>
      ...
      <LegalSection title="2. How We Use Your Information">
        <ul className="list-disc space-y-2 pl-5 marker:text-orange-500">
          ...
          <li>
            To send product updates and important account notices (no spam)
          </li>
        </ul>
      </LegalSection>
      ...
      <LegalSection title="4. Customer Feedback Data">
        <p>
          Feedback submitted by your customers belongs to you. We process it only
          to display it in your dashboard. Customers are informed their feedback
          may be shared with the restaurant owner.
        </p>
      </LegalSection>
      ...
      <LegalSection title="5. Data Retention">
        <ul className="list-disc space-y-2 pl-5 marker:text-orange-500">
          ...
          <li>
            Feedback entries: retained until you delete them or close your
            account
          </li>
          <li>
      ...
      <LegalSection title="8. Security">
        <p>
          All data is encrypted in transit (TLS) and at rest. Passwords are
