...
export default function TermsOfService() {
  return (
    <SiteLegalLayout
      ...
      documentTitle="Terms of Service — ReviewBoost"
    >
      <LegalSection title="1. Acceptance of Terms">
        <p>
          By creating an account on ReviewBoost, you agree to these Terms of Service. If you do
          not agree, please do not use the service.
        </p>
      </LegalSection>

      <LegalSection title="2. Description of Service">
        <p>ReviewBoost is a review management platform that helps restaurant owners:</p>
      ...
      <LegalSection title="3. Account Responsibilities">
        <ul className="list-disc space-y-2 pl-5 marker:text-orange-500">
          ...
          <li>
            One account per business owner — multiple restaurants can be managed under one account
          </li>
        </ul>
      </LegalSection>
      ...
      <LegalSection title="4. Acceptable Use">
        ...
        <LegalHighlight>
          ...
          <p className="mt-2">
            ReviewBoost is a feedback collection tool. Routing genuine positive experiences to
            Google is permitted. Fabricating reviews violates Google&apos;s policies and is
            strictly prohibited.
          </p>
        </LegalHighlight>
      </LegalSection>
      ...
      <LegalSection title="6. Intellectual Property">
        <p>
          ReviewBoost and all its content, branding, and code are owned by us. You retain
          ownership of all feedback data you collect through the platform.
        </p>
      </LegalSection>
      ...
      <LegalSection title="8. Limitation of Liability">
        ...
        <p>Our maximum liability is limited to the amount you paid in the last 30 days.</p>
      </LegalSection>

      <LegalSection title="9. Changes to Terms">
        <p>
          We may update these terms. We will notify you by email at least 7 days before
      ...
      <LegalSection title="10. Governing Law">
        <p>
          These terms are governed by the laws of India. Any disputes will be resolved in courts of
          Mumbai, Maharashtra.
        </p>
      </LegalSection>
