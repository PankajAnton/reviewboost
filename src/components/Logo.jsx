...
function BubbleGlyph({ bubbleFill, bubbleStroke, starFill, className = "" }) {
  ...
  return (
    ...
    >
      ...
      />
      {/* Larger pentagon star centered on bubble body (28×22.1) */}
      <g transform="translate(-2.15, 0)">
        <path
          fill={starFill}
          d="M28 15.75 29.508 20.025 34.039 20.138 30.439 22.893 31.732 27.237 28 24.665 24.268 27.237 25.561 22.893 21.961 20.138 26.492 20.025Z"
        />
      </g>
    </svg>
  );
